...
connectedness of financial markets and its interactions (F. X. Diebold
and Yilmaz 2009, F. X. Diebold and Yilmaz (2012), F. X. Diebold and
Yilmaz (2013), F. X. Diebold and Yilmaz (2014), Barunik and Krehlik
...
Klößner and Sekkel (2014) analyze the spillover of economic policy
uncertainty index for six developed countries, finding that spillovers
are resposible to more than one-fourth of the dynamics of the the
economic policy uncertainty. As expected, the US and UK are the main net
transmister of shocks after the financial crisis in 2008. Awartani,
Aktham, and Cherif (2016) investigate the directional risk transfer from
oil to US equities, Euro/Dollar exchange rates, precious metals and
agricultural commodities, concluding that there exist significant
volatility transmission from oil to equities, however the agricultural
commodities market is not well interconnected to the oil market.

\section{Billio et al. (2012) measure the connectedness of returns of
hedge funds, banks, broker/dealers, and insurance companies based on
...
entities in terms of market
capitalisation.}\label{billio2012-measure-the-connectedness-of-returns-of-hedge-funds-banks-brokerdealers-and-insurance-companies-based-on-principal-components-analysis-and-granger-causality-networks-bubak2011-study-the-dynamics-of-volatility-transmission-between-central-european-ce-currencies-and-the-eurusd-foreign-exchange-cimini2015-80-largest-eurozone-financial-and-non-financial-entities-in-terms-of-market-capitalisation.}
...
countries do not go out of business. In terms of international
competitiveness, UNCTAD (2012) defines international competitiveness as
the country's advantage or disadvantage in trading in the international
markets. This narrow definition lies on the concept of relative price or
cost in which lower relative cost bring more advantages in trading in
the international markets.However, even the narrow definition of
international competitiveness is not free of misinterpretation given
that the relative price/cost can be both cause and result(Turner and
Van'tdack 1993).

In this study, we follow the definition of international competitiveness
from UNCTAD (2012) and Turner and Van'tdack (1993) in which the real
exchange rate is able to capture the relative disadvantageds and
advantages in tranding in the international markets since it measure the
real value of a country's good against the same good in different
countries. The measurement of the real exchange rate brings us to
another problem that there is no index that perfectly represents the
real exchange rate. There are different indexes in the literature, each
of which with its on drawbacks. Among those, the real effective exchange
rate (REER) index is the prevalent proxy for the international
competitiveness (see Turner and Van'tdack 1993, Klau and Fung (2006)).
The REER is an index based on trade-weighted average of bilateral
exchange rates of a currency against a basket of currencies adjusted by
inflation in which according to Klau and Fung (2006), it is a superior
indicator related to macroeconomic effects of exchange rate compared to
any other bilateral rate since it take into account both nominal
exchange rate and the inflation differential vis-à-vis trading partners.
In both policy and market analysis, the REER servea various purposes: as
a measure of international competitiveness, as components of
...
operational target (Klau and Fung 2006). Turner and Van'tdack (1993)
clarify that if a country becomes more successful in the non-price
dimensions of performance, i.e.~innovative, flexible, high-quality
goods, etc, then the real exchange rate would be
