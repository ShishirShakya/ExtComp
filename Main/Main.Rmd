...
ssplot <- function(tab, name, df_date, w, r, c,legend.names, ...){
  ...
  addLegend('topleft', on=1, cex = 0.75,
            legend.names = legend.names,lty=c(1, 1,1,1), lwd=c(2,2,2,2),
            col=c('black', 'red','green', 'blue'))
}
par(mfrow=c(3,2))
ssplot(tab_rw, name = "TC_", df_date = df_date, w = 150, r = 8, c = 7, main = 'A1.')
ssplot(tab_rw, name = "TC_", df_date = df_date, w = 250, r = 8, c = 7, main = 'A2.')
ssplot(tab_rw, name = "TC_", df_date = df_date, w = 350, r = 8, c = 7, main = 'A3.')
ssplot(tab_wv, name = "TC_", df_date = df_date, w = 150, r = 8, c = 7, main = 'B1.')
ssplot(tab_wv, name = "TC_", df_date = df_date, w = 250, r = 8, c = 7, main = 'B2.')
ssplot(tab_wv, name = "TC_", df_date = df_date, w = 350, r = 8, c = 7, main = 'B3.')
```
